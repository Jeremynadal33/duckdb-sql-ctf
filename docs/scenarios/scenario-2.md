...
Grâce aux credentials (*AWS*) du scénario précédent, vous accédez aux archives numériques (*bucket S3*). L'emprunteur a signé à la main à chaque emprunt — son nom varie d'un prêt à l'autre. Vous devez retrouver son identité exacte dans l'annuaire des employés.
