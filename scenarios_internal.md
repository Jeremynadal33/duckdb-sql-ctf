...
- `employees.parquet` — Annuaire du personnel
- `badges.parquet` — Registre des badges d'accès
- `departments.parquet` — Liste des départements
...
- [ ] Générer les fichiers Parquet (Scenario 2) et les uploader sur S3
  - [ ] employees.parquet avec metadata JSON (flag part 1 pour Quackie Chan)
  - [ ] badges.parquet avec metadata JSON (flag part 2 pour BADGE-0042, status=inactive)
  - [ ] departments.parquet
